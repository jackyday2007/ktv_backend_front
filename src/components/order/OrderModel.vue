    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body, input-group mb-3">
                ...
                :disabled="modelValue.status === '取消預約' || modelValue.status === '報到'"
                class="form-control"
            ...
            <div class="modal-body, input-group mb-3" v-show="modelValue.status != '' && modelValue.status != '取消預約'">
            ...
            <div class="modal-body, input-group mb-3">
                ...
                :disabled="modelValue.status === '預約' || modelValue.status === '取消預約' || modelValue.status === '報到'"
